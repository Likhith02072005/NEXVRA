...
function WorkSection() {
  ...
  const cases = [
    {
      num: '01',
      tag: '🏆 Awwwards Site of the Day Winner',
      title: 'ARCHETYPE DIGITAL STUDIO',
      desc: 'Award-winning luxury brutalist digital experience featuring interactive WebGL 3D stone artifacts, GSAP scroll storytelling, and custom typography.',
      stats: [
        { val: 'SOTD', label: 'Awwwards Winner' },
        { val: '4.9s', label: 'Avg. Time on Site' },
        { val: '340%', label: 'Lead Growth' },
      ],
      img: '/awwwards-archetype.jpg',
    },
    {
      num: '02',
      tag: '🏆 Awwwards Developer Site of the Year',
      title: 'NOVA DIGITAL REALITIES',
      desc: 'Immersive spatial 3D web application designed for a luxury VR & interactive installation studio. Custom shaders, glassmorphism UI, and sub-1s load times.',
      stats: [
        { val: 'DEVOY', label: 'Developer Winner' },
        { val: '99', label: 'Performance Score' },
        { val: '3.0X', label: 'Client ROAS' },
      ],
      img: '/awwwards-nova.jpg',
    },
    {
      num: '03',
      tag: '🏆 Awwwards Site of the Month',
      title: 'NEXUS AI ENTERPRISE',
      desc: 'End-to-end UX/UI redesign for an enterprise AI analytics platform. Dark mode glass dashboard, real-time data visualization, and 40,000+ daily active users.',
      stats: [
        { val: 'SOTM', label: 'Awwwards Winner' },
        { val: '+67%', label: 'User Retention' },
        { val: '1.2M', label: 'Inferences/Day' },
      ],
      img: '/awwwards-nexus.jpg',
    },
    {
      num: '04',
      tag: '🏆 Awwwards Honors Winner',
      title: 'ARCADE ARCHITECTURAL ATELIER',
      desc: 'Monolithic brutalist web architecture for a European architectural studio. High-contrast typography grid, 3D structural renders, and responsive image distortion.',
      stats: [
        { val: 'HONORS', label: 'Awwwards Mention' },
        { val: '2M+', label: 'Global Traffic' },
        { val: '100', label: 'SEO Score' },
      ],
      img: '/awwwards-arcade.jpg',
    },
  ];
