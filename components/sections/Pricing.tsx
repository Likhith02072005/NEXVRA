      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="p-8 rounded-2xl bg-[#00d4ff]/5 border border-[#00d4ff]/20 flex flex-col relative shadow-[0_8px_30px_rgba(0,212,255,0.05)]" data-cursor-label="Popular!">
            <span className="absolute -top-3.5 left-1/2 -translate-x-1/2 bg-gradient-to-r from-[#00d4ff] to-[#7c3aed] text-text-primary text-[10px] font-extrabold uppercase px-3 py-1 rounded-full tracking-wider">
              ⚡ Most Popular
            </span>
