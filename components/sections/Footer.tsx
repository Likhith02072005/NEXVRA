      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 mb-16">
          ...
          <div className="lg:col-span-5 flex flex-col items-start gap-4">
            ...
            <div className="flex gap-3 mt-2">
              <a 
                ...
                className="w-9 h-9 rounded-xl bg-white/5 border border-white/5 flex items-center justify-center text-slate-400 hover:text-white transition-colors"
          ...
          <div className="lg:col-span-2 lg:col-start-7 flex flex-col gap-4">
            ...
            <ul className="space-y-2 text-xs md:text-sm text-slate-400 font-medium">
          ...
          <div className="lg:col-span-2 flex flex-col gap-4">
            ...
            <ul className="space-y-2 text-xs md:text-sm text-slate-400 font-medium">
              <li><a href="mailto:nexvratech@gmail.com" className="hover:text-white transition-colors">nexvratech@gmail.com</a></li>
              <li><a href="tel:+919606610059" className="hover:text-white transition-colors">+91 96066 10059</a></li>
              <li><span className="text-slate-500">Bangalore, India</span></li>
            </ul>
          </div>

        </div>

        <div className="flex flex-col md:flex-row items-center justify-between border-t border-white/5 pt-8 text-[11px] md:text-xs text-slate-500 font-medium">
