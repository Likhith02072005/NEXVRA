...
export default function Results() {
  return (
    <section id="results" className="py-24 bg-[#0a0a0f] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
          <div className="p-6 rounded-2xl bg-white/[0.01] border border-white/5 text-center">
            ...
            <div className="text-slate-400 text-xs md:text-sm mt-2">Average ROAS</div>
          </div>
          <div className="p-6 rounded-2xl bg-white/[0.01] border border-white/5 text-center">
            <AnimatedNumber end={200} suffix="%" />
            <div className="text-slate-400 text-xs md:text-sm mt-2">More Qualified Leads</div>
          </div>
          <div className="p-6 rounded-2xl bg-white/[0.01] border border-white/5 text-center">
            <AnimatedNumber end={40} suffix="+" />
            <div className="text-slate-400 text-xs md:text-sm mt-2">Happy Clients</div>
          </div>
          <div className="p-6 rounded-2xl bg-white/[0.01] border border-white/5 text-center">
            <AnimatedNumber end={95} suffix="%" />
            <div className="text-slate-400 text-xs md:text-sm mt-2">Client Retention Rate</div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
          ...
          <div className="p-8 rounded-2xl bg-white/[0.02] border border-white/5 flex flex-col justify-between hover:border-[#00d4ff]/20 transition-all hover:bg-white/[0.04]" data-cursor-label="Case Study">
            <div>
              ...
              <h4 className="text-lg font-bold text-white mt-4 mb-2">BloomCafe — Koramangala</h4>
            ...
            <div className="grid grid-cols-2 gap-4 border-t border-white/5 pt-6">
              <div>
                ...
                <div className="text-slate-400 text-[10px] md:text-xs mt-1">Increase in Online Orders</div>
              </div>
              <div>
                <AnimatedNumber end={4.2} suffix="x" decimals={true} />
                <div className="text-slate-400 text-[10px] md:text-xs mt-1">Return on Ad Spend</div>
              </div>
            </div>
          </div>
          ...
          <div className="p-8 rounded-2xl bg-white/[0.02] border border-white/5 flex flex-col justify-between hover:border-[#7c3aed]/20 transition-all hover:bg-white/[0.04]" data-cursor-label="Case Study">
            <div>
              ...
              <h4 className="text-lg font-bold text-white mt-4 mb-2">UrbanFit Studio — Indiranagar</h4>
              <p className="text-slate-400 text-xs md:text-sm leading-relaxed mb-6">
            ...
            <div className="grid grid-cols-2 gap-4 border-t border-white/5 pt-6">
              <div>
                ...
                <div className="text-slate-400 text-[10px] md:text-xs mt-1">New Members in 30 Days</div>
              </div>
              <div>
                <AnimatedNumber end={67} suffix="%" />
                <div className="text-slate-400 text-[10px] md:text-xs mt-1">Reduction in Cost per Lead</div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="p-8 rounded-2xl bg-white/[0.01] border border-white/5 flex flex-col justify-between" data-cursor-label="Testimonial">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-slate-400 text-xs">Owner, BloomCafe</div>
              </div>
            </div>
          </div>
          ...
          <div className="p-8 rounded-2xl bg-white/[0.01] border border-white/5 flex flex-col justify-between" data-cursor-label="Testimonial">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-slate-400 text-xs">Founder, UrbanFit Studio</div>
              </div>
            </div>
          </div>
          ...
          <div className="p-8 rounded-2xl bg-white/[0.01] border border-white/5 flex flex-col justify-between" data-cursor-label="Testimonial">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-sm font-bold text-white">Arjun Venkat</div>
                <div className="text-slate-400 text-xs">Co-founder, KriyaTech</div>
              </div>
            </div>
          </div>
